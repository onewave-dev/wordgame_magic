...
- В тестовой игре за второго игрока играет **дамми‑бот**, который отправляет **валидное слово каждые 30 секунд**; приглашение иных игроков не предусмотрено и интерфейс приглашения не показывается.
